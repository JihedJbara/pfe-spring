package com.github.m0uj.starter.expense.web.controller.dto;

/**
 * Created by Jihed-pc on 16/05/2018.
 */
public class DOC_FRAISDTO {
    ...
    public int getTotale_froute() {
        return totale_froute;
    }

    public void setTotale_froute(int totale_froute) {
        this.totale_froute = totale_froute;
    }
}
